...
Client (Frontend / Postman) ↓ Flask REST API ↓ Input Validation & Preprocessing ↓ Machine Learning Model (best_model.pkl) ↓ Disease Classification ↓ Risk Assessment Logic ↓ Medicine & Advice Mapping ↓ JSON Response
